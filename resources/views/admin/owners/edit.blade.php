                                    ...
                                    <div class="-m-2">
                                        ...
                                        <div class="p-2 w-1/2 mx-auto">
                                            <div class="relative">
                                                ...
                                                <div class="w-full bg-gray-100 bg-opacity-50 rounded text-base outline-none text-gray-700 py-1 px-3 leading-8">{{ $owner->shop->name }}</div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="p-2 w-full flex justify-center space-x-4 mt-4">
